export default {
    ...
    EVENT_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this event ? This action is ireversable",
    EVENT_ORDER_VIEW_TITLE: "Order",
    EVENT_ORDER_NEW_TITLE: "New Order",
    EVENT_ORDER_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this order ? This action is ireversable",
    MENU_VIEW_TITLE: "Menu",
    MENU_NEW_TITLE: "New Menu",
    MENU_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this menu ? This action is ireversable",
    OPERATOR_VIEW_TITLE: "Operator",
    OPERATOR_NEW_TITLE: "New Operator",
    OPERATOR_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this operator ? This action is ireversable",
    PRODUCT_VIEW_TITLE: "Product",
    PRODUCT_NEW_TITLE: "New Product",
    PRODUCT_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this product ? This action is ireversable",
    PRODUCT_VARIANT_VIEW_TITLE: "Product Variant",
    PRODUCT_VARIANT_NEW_TITLE: "New Product Variant",
    PRODUCT_VARIANT_REGISTRY_DELETE_MESSAGE: "Do you really want to delete this product variant ? This action is ireversable",
    /**
     * API Error
     */
    ...
    ERROR_OPERATOR_DISPLAY_NAME_GREATER_THAN_MAX_LENGTH: "Operator display name is greater than the max length",
    ERROR_OPERATOR_DISPLAY_NAME_GREATER_THAN_MIN_LENGTH: "Operator display name is less than the min length",
    ...
    ERROR_OPERATOR_USER_NAME_GREATER_THAN_MAX_LENGTH: "Operator user name is greater than the max length",
    ...
    ERROR_ORDER_CLIENT_NAME_GREATER_THAN_MAX_LENGTH: "Order client name is greater than the max length",
    ...
    ERROR_VARIANT_NAME_GREATER_THAN_MAX_LENGTH: "Product variant name is is greater than the max length",
    ...
    ERROR_JWT_ACCESS_TOKEN_SETTINGS_INVALID: "JWT access token settings are invalid, please contact the administrator",
    ERROR_JWT_ACCESS_TOKEN_NOT_FOUND: "Access token was not found",
    ERROR_JWT_ACCESS_TOKEN_INVALID: "Access token is invalid",
    ERROR_JWT_REFRESH_TOKEN_SETTINGS_INVALID: "JWT refresh token settings are invalid, please contact the administrator",
