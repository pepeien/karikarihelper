export default {
    ...
    EVENT_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir este evento ? Esta ação é irreversível",
    EVENT_ORDER_VIEW_TITLE: "Pedido",
    EVENT_ORDER_NEW_TITLE: "Novo Pedido",
    EVENT_ORDER_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir este pedido ? Esta ação é irreversível",
    MENU_VIEW_TITLE: "Menu",
    MENU_NEW_TITLE: "Novo Menu",
    MENU_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir este menu ? Esta ação é irreversível",
    OPERATOR_VIEW_TITLE: "Operador",
    OPERATOR_NEW_TITLE: "Novo Operador",
    OPERATOR_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir este(a) operador(a) ? Esta ação é irreversível",
    PRODUCT_VIEW_TITLE: "Produto",
    PRODUCT_NEW_TITLE: "Novo Produto",
    PRODUCT_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir este produto ? Esta ação é irreversível",
    PRODUCT_VARIANT_VIEW_TITLE: "Variante de Produto",
    PRODUCT_VARIANT_NEW_TITLE: "Nova Variante de Produto",
    PRODUCT_VARIANT_REGISTRY_DELETE_MESSAGE: "Você realmente quer excluir esta variante de produto ? Esta ação é irreversível",
    /**
     * API Error
     */
    ...
    ERROR_OPERATOR_DISPLAY_NAME_GREATER_THAN_MAX_LENGTH: "Nome de exibição do(a) operador(a) é muito grande",
    ERROR_OPERATOR_DISPLAY_NAME_GREATER_THAN_MIN_LENGTH: "Nome de exibição do(a) operador(a) é muito pequeno",
    ...
    ERROR_OPERATOR_USER_NAME_GREATER_THAN_MAX_LENGTH: "Nome de usuário(a) do(a) operador(a) é muito grande",
    ERROR_OPERATOR_USER_NAME_LESS_THAN_MIN_LENGTH: "Nome de usuário(a) do(a) operador(a) é muito pequeno",
    ...
    ERROR_JWT_SETTINGS_INVALID: "Configurações do JWT são inválidas, por favor, contate do administrador",
    ERROR_JWT_ACCESS_TOKEN_SETTINGS_INVALID: "Configurações do token de acesso são inválidas, por favor, contate do administrador",
    ERROR_JWT_ACCESS_TOKEN_NOT_FOUND: "Token de acesso é obrigatório",
    ERROR_JWT_ACCESS_TOKEN_INVALID: "Token de acesso é inválido",
    ERROR_JWT_REFRESH_TOKEN_SETTINGS_INVALID: "Configurações do token de atualização são inválidas, por favor, contate do administrador",
